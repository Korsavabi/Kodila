...
jQuery(document).ready(function ($) {
  var outs = document.querySelectorAll('.owl-out');

  var _iterator = _createForOfIteratorHelper(outs),
      _step;

  try {
    var _loop = function _loop() {
      var out = _step.value;
      var owl = out.querySelector('.owl-carousel');
      var btns = out.querySelectorAll(':scope .thumb');
      var owlJq = $(owl);
      owlJq.owlCarousel({
        loop: true,
        margin: 10,
